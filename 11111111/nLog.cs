...
namespace Common.log1
{
    public class NLOG1
    {
        ...
        public NLOG1(string methodName) : this(LogManager.GetLogger(methodName))
        {
        }

        //static constructor instantiate the Log 
        //before instantiating first class or reference any static member.
        public static NLOG1 Logger { get; private set; }
        static NLOG1()
        {
            Logger = new NLOG1(LogManager.GetCurrentClassLogger());
        }
